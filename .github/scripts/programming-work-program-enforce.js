...
const owned=new Map((packet.owned_capabilities||[]).map(x=>[x.capability_id,x.module_key]));
assert(owned.get('C01')==='AUTOMATION'&&owned.get('C05')==='CODE'&&owned.get('C40')==='WEBSITE_BUILDING','Programming packet capability ownership incomplete');
