...
const qualifier = path.join(subjectRoot, '.github', 'scripts', 'book-system-lifecycle-current-parent-compatibility-001-qualify-v2.js');
...
if (result.error) {
  console.error(`BOOK_SYSTEM_LIFECYCLE_CURRENT_PARENT_COMPATIBILITY_001_WRAPPER_SPAWN_ERROR:${result.error.message}`);
  process.exit(2);
}
