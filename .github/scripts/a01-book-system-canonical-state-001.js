...
const qualifier = path.join(subjectRoot, '.github', 'scripts', 'book-system-canonical-state-001-qualify.js');
...
if (result.error) {
  console.error(`BOOK_SYSTEM_CANONICAL_STATE_WRAPPER_SPAWN_ERROR:${result.error.message}`);
  process.exit(2);
}
