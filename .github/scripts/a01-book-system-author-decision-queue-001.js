...
const qualifier = path.join(subjectRoot, '.github', 'scripts', 'book-system-author-decision-queue-001-qualify-v2.js');
...
if (result.error) {
  console.error(`BOOK_SYSTEM_AUTHOR_DECISION_QUEUE_001_WRAPPER_SPAWN_ERROR:${result.error.message}`);
  process.exit(2);
}
