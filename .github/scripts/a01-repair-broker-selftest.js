...
assert(bookEvaluator.transaction.owner_path === 'SYSTEM_MASTER/BOOK', 'Book evaluator workstream must route through Book');
...
expectThrow(() => openTransaction(base({ receipt_id:'receipt-literary-retired', workstream_id:'LITERARY-PROSE', qualification_id:'LITERARY-EXAMPLE', receipt:{result_class:'SUBJECT_FAILURE'} })), 'UNALLOCATED_WORKSTREAM:LITERARY-PROSE');
...
console.log('retired_prose_repair_route=REJECTED');
