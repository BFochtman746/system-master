...
const qualifier = path.join(subjectRoot, '.github', 'scripts', 'book-system-service-interface-001-qualify.js');
...
if (result.error) {
  console.error(`BOOK_SYSTEM_SERVICE_INTERFACE_WRAPPER_SPAWN_ERROR:${result.error.message}`);
  process.exit(2);
}
