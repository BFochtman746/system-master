...
1. **Recover and rebind Intent / Keel, then lock its exact boundary into the canonical Work Chain.** Preserve historical goal/requirements/constraint/delegation/resource-ceiling semantics where sound; prove that Keel owns intent and ceilings without becoming concrete Identity delegation, Resource Admission, Work/Project, Orchestration, Routing, Placement or Runtime truth.
