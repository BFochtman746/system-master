...
1. Foundation-002's 39 tests remain green unchanged.
...
17. Historical Foundation-002 migrations remain checksum-identical and append-only; Foundation-003 adds migration 004.
18. `controller-v2/foundation-003` is the only active integration branch for this stage; Foundation-002 remains frozen.
