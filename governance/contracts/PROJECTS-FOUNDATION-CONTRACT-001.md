...
- **Module name:** Projects / Goal Work System
- **Interaction direction:** CORE_SHARED_WORK_CAPABILITY
- **Census standing:** `CURRENT_CANONICAL_OWNER_CAPABILITY__PARTIAL`
- **Census evidence summary:** Current topology assigns shared work/runtime foundations to CORE and preserved KEEL/project/work primitives exist, but the historical Projects module's complete end-user product surface is not separately proven by P1.
