...
- **Module name:** Voice / Speech System
- **Interaction direction:** HEADLESS_SPEECH_CAPABILITY_WITH_INTERACTIVE_SURFACE_WHERE_NEEDED
- **Census standing:** `RESEARCH_CLOSED__IMPLEMENTATION_NOT_CURRENTLY_PROVEN`
- **Census evidence summary:** Historical Voice research is closed but implementation/empirical/production proof was absent.
