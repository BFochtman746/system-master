# P13 — Foundation Contract 001

**Owner** `SYSTEM_MASTER/CORE` · **Capability** P13 Model routing and local inference · **Effective** <UNSET>
...
## Known from the crosswalk

- **Requirement:** Model routing and local inference
- **Present in repo as:** **nothing — this requirement has no implementation**

This platform requirement was invisible until the crosswalk named it. Section 1
must decide whether it is built, deferred with authority, or absorbed elsewhere.
