...
def main():
    ...
    check(source_closure["standing"] == "PROSE_OWNER_LANE_FOUNDATION_CENSUS_COMPLETE_WITH_ONE_DURABLE_FRESH_CONTEXT_BLOCKER__GLOBAL_FOUNDATION_NOT_CLAIMED", "source_owner_closure_standing")
    ...
    check("No global System Master Foundation 1.0 closure is claimed." in source_closure["preserved_nonclaims"], "source_owner_closure_global_nonclaim")
    check("Global Foundation 1.0 is closed." in source_closure["parent_handoff"]["parent_may_not_infer"], "source_owner_closure_parent_inference_guard")
