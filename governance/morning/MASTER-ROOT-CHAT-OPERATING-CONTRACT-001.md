...
MASTER_ROOT reads all four owner lanes and shared infrastructure so it can maintain product-level sequencing, architecture, completion/obligation coherence, tool allocation, cross-lane interfaces and global next steps.

It does not silently take child canonical-writer authority. CORE remains Foundation & Spine owner; LEARNING remains Learning owner; BOOK remains Book owner; PROSE remains Book/Prose child owner.
...
5. fetch live control refs/heads for CORE, LEARNING, BOOK and PROSE;
6. compare them to the morning packet and sealed checkpoint;
7. reconcile any `AUTHORITY_DELTA` from durable evidence;
8. read current completion, obligation, expectation, repair and relevant Second Shift standing;
...
MASTER_ROOT may directly execute current SYSTEM_MASTER root-owned governance/architecture/reconciliation work.
